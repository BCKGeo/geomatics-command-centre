...
export function MunicipalTable({ rows, B, selectedId, onRowClick, userLat, userLon }) {
  ...
  const linkLabels = isNarrow
    ? { gis: "GIS", municipal: "Mun", standards: "Stds" }
    : { gis: "GIS", municipal: "Municipal", standards: "Standards" };
                ...
                >
                  ...
                  <td style={{ ...cellStyle, textAlign: "center", fontSize: 10 }}>
                    {r.portalUrl || r.municipalUrl || r.surveyStandards ? (<>
                      {r.portalUrl && <a href={r.portalUrl} target="_blank" rel="noopener noreferrer" title="Open Data / GIS Portal" style={{ color: "#c08800", textDecoration: "none", marginRight: 4 }}>{linkLabels.gis}</a>}
                      {r.municipalUrl && <a href={r.municipalUrl} target="_blank" rel="noopener noreferrer" title="Municipal Website" style={{ color: B.pri, textDecoration: "none", marginRight: 4 }}>{linkLabels.municipal}</a>}
                      {r.surveyStandards && <a href={r.surveyStandards} target="_blank" rel="noopener noreferrer" title="Survey Standards" style={{ color: "#4caf50", textDecoration: "none" }}>{linkLabels.standards}</a>}
