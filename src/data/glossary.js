...
export const GLOSSARY = {
  ...
  "Flight Ops": [
    ...
    {dt:"BVLOS",dd:"Beyond Visual Line of Sight. Permitted under the Level 1 Complex certificate (in force since Nov 2025) for lower-risk operations without SFOC."},
    ...
    {dt:"EVLOS",dd:"Extended Visual Line of Sight. Advanced-cert operation using a certified Visual Observer to maintain airspace awareness. 3.7 km (2 NM) max range. In force since Nov 2025."},
    {dt:"RPOC",dd:"RPAS Operator Certificate. Required for organizations conducting Level 1 Complex operations. $125 fee. In force since Apr 2025."},
    {dt:"Sheltered Operations",dd:"Advanced-cert flights near structures (30 m above, 61 m horizontal) without direct VLOS. Controlled airspace permitted with declarations. In force since Nov 2025."},
