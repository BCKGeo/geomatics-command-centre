...
export const SECTIONS = [
  { title:"Transport Canada — RPAS", color:"#3bbffa", icon:"✈️", links:[
    ...
    {n:"Operation Categories & Pilot Certs",d:"2025 framework: Micro, Basic, Advanced, Level 1 Complex, Special",u:"https://tc.canada.ca/en/aviation/drone-safety/learn-rules-you-fly-your-drone/drone-operation-categories-pilot-certificates"},
    {n:"Level 1 Complex Operations",d:"BVLOS certification pathway, requirements, and operational limits",u:"https://tc.canada.ca/en/aviation/drone-safety/learn-rules-you-fly-your-drone/drone-operation-categories-pilot-certificates/level-1-complex-operations"},
  ...
  { title:"GIS", color:"#3bbffa", icon:"🗺️", links:[
    ...
    {n:"Canada Open Data Portal",d:"Government of Canada open datasets",u:"https://search.open.canada.ca/opendata/"},
