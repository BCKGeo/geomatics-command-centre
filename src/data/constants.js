...
export const NOAA_F107 = "https://services.swpc.noaa.gov/products/summary/10cm-flux.json";
export const NOAA_XRAY = "https://services.swpc.noaa.gov/json/goes/primary/xrays-6-hour.json";
